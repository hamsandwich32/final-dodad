def intro_part():
	...
	print("You look around once more and see your bag on your table, you grab it.\n")
	...
	while True:
		...
		try:
			if int(bn) == 1:
				...
				print("You check your table as well and find your broomstick. You realize that you can use it to grab what's underneath your bed.\n")
				print("You check back under your bed and use your broomstick to grab the thing under your bag. You pull it out and realize its the bag of salt for your snail!\n")
				break 
			else:
